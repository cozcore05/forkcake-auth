<template>
    <div class="flex justify-center items-center min-h-screen">
      <div class="text-center">
        ...
        <div class="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-blue-500 mx-auto mb-4" v-if="loading"></div>
        <p class="text-gray-600" v-if="loading">Please wait while we verify your email.</p>
        <p class="text-green-600" v-if="success">{{resonse_message}} Redirecting to login page...</p>
